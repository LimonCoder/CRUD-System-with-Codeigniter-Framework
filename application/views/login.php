...
<head>
	...
	<link rel="apple-touch-icon" sizes="120x120" href="<?=base_url()?>assets/<?=base_url()?>assets/favicon/apple-icon-120x120.png">
	<link rel="icon" type="image/png" sizes="192x192" href="<?=base_url()?>assets/<?=base_url()?>assets/favicon/android-icon-192x192.png">
	<link rel="icon" type="image/png" sizes="32x32" href="<?=base_url()?>assets/<?=base_url()?>assets/favicon/favicon-32x32.png">
	<link rel="icon" type="image/png" sizes="16x16" href="<?=base_url()?>assets/<?=base_url()?>assets/favicon/favicon-16x16.png">
	<!--BASIC css-->
	<!-- ========================================================= -->
...
<div class="wrap">
	...
	<div class="page-body animated slideInDown">
		...
		<!--LOGO-->
		<div class="logo">
			<img alt="logo" src="<?=base_url()?>assets/images/logo-dark.png" />
		</div>
		<div class="box">
			<!--SIGN IN FORM-->
			<?php
				if ($this->session->flashdata('error') != ''){ ?>
					<div class="alert alert-danger">
						<strong>Wrong !</strong><?=$this->session->flashdata('error');?>
					</div>
			<?php	}
			?>
				...
				<div class="panel-content bg-scale-0">
					<form action="<?=base_url()?>login" method="post">
						<div class="form-group mt-md">
							...
							<span style="font-family:'Times New Roman'; color: red" ><?=form_error("email_address")?></span>
						</div>
						<div class="form-group">
							...
							<span style="font-family:'Times New Roman'; color: red" ><?=form_error("password")?></span>
						</div>
						<div class="form-group">
